...
\input{my_folder/practiceWorkTitle}		     % Титульный лист
...
\input{my_folder/chapter7}           	 % Глава 7
...
\input{my_folder/appendix_tests}			 % Приложение 1
%
\input{my_folder/appendix_code}			 	 % Приложение 2
