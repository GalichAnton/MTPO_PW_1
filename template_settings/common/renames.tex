...
%%
%%
\newcommand{\Author}{А.А.\,Галич} % И.О. Фамилия автора
\newcommand{\AuthorFull}{Галич Антон Андреевич} % Фамилия Имя Отчество автора
\newcommand{\AuthorFullDat}{Галичу Антону Андреевичу} % Фамилия Имя Отчество автора в дательном падеже (Кому? Студенту...)
\newcommand{\AuthorFullVin}{Галича Антона Андреевича} % в винительном падеже (Кого? что?  Програмиста ...)
\newcommand{\AuthorPhone}{+7-921-393-46-23} % номер телефорна автора для оперативной связи
\newcommand{\Supervisor}{В.А.\,Пархоменко} % И. О. Фамилия научного руководителя
\newcommand{\SupervisorFull}{Пархоменко Владимир Алексеевич} % Фамилия Имя Отчество научного руководителя
...
\newcommand{\HeadDegree}{старший преподаватель}% Только должность:
...
%% Практические работы  2-ой курс

\newcommand{\practiceNumber}{1} % номер практической работы
\newcommand{\practiceDiscipline}{Методы тестирования программного обеспечения} % название дисциплины
\newcommand{\practiceWorkTitle}{Разработка кода через модульное тестирование} % название работы
