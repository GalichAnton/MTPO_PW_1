...
В данной главе представлена разработка тестовой документации для приложения топологической сортировки, реализующего алгоритмы DFS и Кана. Сначала определены проверяемые условия (test cover items), затем для каждого метода тестирования разработаны контрольные примеры (test cases). В завершение главы приведён сравнительный анализ использованных методов с оценкой трудозатрат и рекомендациями по оптимизации тестового набора.
