...
\section{Сводная таблица классов}

В таблице~\ref{tab:code_summary} представлена сводная информация о реализованных классах.

\begin{table}[H]
    \centering
    \caption{Сводная таблица классов приложения}
    \label{tab:code_summary}
    \small
    \begin{tabular}{|l|l|c|c|}
        \hline
        \textbf{Класс} & \textbf{Пакет} & \textbf{Строк кода} & \textbf{Методов} \\
        \hline
        Graph & model & 120 & 12 \\
        \hline
        SortResult & model & 70 & 8 \\
        \hline
        ComparisonResult & model & 150 & 15 \\
        \hline
        TopologicalSortAlgorithm & algorithm & 15 & 2 \\
        \hline
        DfsTopologicalSort & algorithm & 80 & 3 \\
        \hline
        KahnTopologicalSort & algorithm & 70 & 2 \\
        \hline
        JsonGraphHandler & io & 180 & 8 \\
        \hline
        SortValidator & util & 90 & 3 \\
        \hline
        Application & (root) & 250 & 12 \\
        \hline
        \textbf{Итого} & & \textbf{$\sim$1025} & \textbf{65} \\
        \hline
    \end{tabular}
\end{table}