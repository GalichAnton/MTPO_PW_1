...
\subsection*{Тестирование валидного класса EP1: Пустой граф}
...
\subsection*{Тестирование валидного класса EP2: Ациклический граф}
...
\subsection*{Тестирование невалидного класса EP3: Граф с циклом}
...
\subsection*{Тестирование невалидного класса EP4: Некорректный формат}
...
\subsection*{Граница минимального размера: 0 и 1 вершина}
...
\subsection*{Граница связности: 2 вершины}
...
\subsection*{Параметризованный тест для полных DAG}
...
\subsection*{Тестирование большого графа}
...
\subsection*{Вложенные тестовые классы для Decision Table}
...
\subsection*{Тестирование правил обработки ошибок}
...
\subsection*{Реализация тестов Branch Testing} \label{ch5:branch}
...
\subsection*{Организация тестов ветвей}
...
\subsection*{Тестирование ветви обнаружения цикла}
...
\subsection*{Тестирование ветви пропуска посещённых вершин}
...
\subsection*{Использование Mock-объектов}
...
\subsection*{Использование Spy-объектов}
