...
\subsection{TC-EP-02: Ациклический граф (DAG)}\label{lst:ep02}
...
\subsection{TC-EP-03: Граф с циклом}\label{lst:ep03}
...
\subsection{TC-EP-04: Некорректный формат}\label{lst:ep04}
...
\subsection{TC-BVA-01 и TC-BVA-02: Минимальные размеры}\label{lst:bva01}
...
\subsection{TC-BVA-03 и TC-BVA-04: Граница связности}\label{lst:bva03}
...
\subsection{TC-BVA-05: Параметризованный тест полного DAG}\label{lst:bva05}
...
\subsection{TC-BVA-06: Большой граф}\label{lst:bva06}
...
\subsection{Вложенный класс тестов Decision Table}\label{lst:dt01}
...
\subsection{Тесты обработки ошибок ввода-вывода}\label{lst:dt04}
...
\subsection{Тесты покрытия ветвей алгоритма DFS}\label{lst:br01}
...
\subsection{Mock-объекты и верификация вызовов}\label{lst:mockito}
...
\subsection{Spy-объекты и сравнение алгоритмов}\label{lst:spy}
